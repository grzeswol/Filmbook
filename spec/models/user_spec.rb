...
describe User do
	...
	describe "whenn password confirmation doesn't match" do
	...
	describe "user email with mixed case" do
		let(:mixed_case_emali) { "Foo@ExaMpLE.CoM" }

		it "should be saved as lower-case" do
			@user.email = mixed_case_emali
			@user.save
			expect(@user.reload.email).to eq mixed_case_emali.downcase
		end
	end
